...
| Дата | Что сделано |
|---|---|
| 15.05.2026 | Добавлен раздел «Лента сообщений» в дашборд Линнимакс — фильтрация по тональности (позитив / нейтрал / негатив), данные из ручного экспорта BA за апрель 2026. Создан `tonal/parse.js` для конвертации экспорта в `messages-YYYY-MM.json`. |
